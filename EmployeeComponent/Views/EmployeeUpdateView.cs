...
namespace EmployeeComponent.Views
{
	public class EmployeeUpdateView
	{
		...
		public void RunUpdateView()
		{
			Console.WriteLine();
			Console.WriteLine();
			Console.WriteLine("Please enter the ID of the employee you want to edit");
			...
			if (index != -1)
			{
				...
				Console.WriteLine(EmployeeCommonOutputText.GetUpdateViewAdditionalInstructions(employee));
